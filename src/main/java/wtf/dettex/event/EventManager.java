package wtf.dettex.event;

import net.minecraft.text.Text;
import net.minecraft.util.Formatting;
import wtf.dettex.event.events.Event;
import wtf.dettex.event.events.EventStoppable;
import wtf.dettex.event.types.Priority;
import wtf.dettex.api.system.logger.implement.ConsoleLogger;
import wtf.dettex.api.system.logger.implement.MinecraftLogger;
