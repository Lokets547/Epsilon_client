    ...
    public void drawDraggable(DrawContext context) {
        ...
        for (Notification notification : list) {
            ...
            MathUtil.setAlpha(anim, () -> {
                blurGlass.render(ShapeProperties.create(matrix, startX, startY, width, getHeight()).round(3)
                        .outlineColor(ColorUtil.getOutline()).color(ColorUtil.getRect(Hud.newHudAlpha.getValue())).build());
