...
package wtf.dettex.implement.features.commands.argument;

import wtf.dettex.api.other.command.argument.IArgConsumer;
import wtf.dettex.api.other.command.argument.ICommandArgument;
import wtf.dettex.api.other.command.datatypes.IDatatype;
import wtf.dettex.api.other.command.datatypes.IDatatypeContext;
import wtf.dettex.api.other.command.datatypes.IDatatypeFor;
import wtf.dettex.api.other.command.datatypes.IDatatypePost;
import wtf.dettex.api.other.command.exception.CommandException;
import wtf.dettex.api.other.command.exception.CommandInvalidTypeException;
import wtf.dettex.api.other.command.exception.CommandNotEnoughArgumentsException;
import wtf.dettex.api.other.command.exception.CommandTooManyArgumentsException;
import wtf.dettex.api.other.command.manager.ICommandManager;
