...
package wtf.dettex.implement.features.commands.argparser;

import wtf.dettex.api.other.command.argparser.IArgParser;
...
import wtf.dettex.api.other.command.exception.CommandNoParserForTypeException;
