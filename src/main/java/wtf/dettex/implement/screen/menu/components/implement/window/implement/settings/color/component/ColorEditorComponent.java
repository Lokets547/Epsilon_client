package wtf.dettex.implement.screen.menu.components.implement.window.implement.settings.color.component;
...
public class ColorEditorComponent extends AbstractComponent {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        blurGlass.render(ShapeProperties.create(matrix, x + 6, y + 90.5F, 31, 14)
                .round(1.5F).thickness(2).outlineColor(ColorUtil.getOutline(0.8F)).color(ColorUtil.getRect(0.45F)).build());

        Fonts.getSize(13).drawString(context.getMatrices(), "HEX", x + 10, y + 96, -1);

        blurGlass.render(ShapeProperties.create(matrix, x + 40, y + 90.5F, 80, 14)
                .round(1.5F).thickness(2).outlineColor(ColorUtil.getOutline(0.8F)).color(ColorUtil.getRect(0.45F)).build());

        Fonts.getSize(13).drawString(context.getMatrices(), "#" + Integer.toHexString(setting.getColor()), x + 45, y + 96, -1);

        blurGlass.render(ShapeProperties.create(matrix, x + 122, y + 90.5F, 22, 14)
                .round(1.5F).thickness(2).outlineColor(ColorUtil.getOutline(0.8F)).color(ColorUtil.getRect(0.45F)).build());
