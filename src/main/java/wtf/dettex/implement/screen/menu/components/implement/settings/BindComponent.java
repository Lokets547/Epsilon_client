...
public class BindComponent extends AbstractSettingComponent {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // Fixed height; no detailed description below
        height = 22;

        blurGlass.render(ShapeProperties.create(matrix, x + width - stringWidth - 17, y + 5, stringWidth + 10, 12)
        ...
        Fonts.getSize(14, BOLD).drawString(matrix, setting.getName(), x + 7, y + 8.4, 0xFFD4D6E1);
    }
