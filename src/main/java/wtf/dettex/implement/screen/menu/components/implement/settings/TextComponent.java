...
public class TextComponent extends AbstractSettingComponent {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // Compact fixed height; no detailed description below
        height = 22;
        ...
        blurGlass.render(ShapeProperties.create(matrix, rectX, rectY, rectWidth, rectHeight)
                .round(2).thickness(2).outlineColor(ColorUtil.getOutline()).color(ColorUtil.getRect(0.5F)).build());
        ...
        if (typing && selectionStart != -1 && selectionEnd != -1 && selectionStart != selectionEnd) {
            ...
            if (start < end) {
                ...
                blurGlass.render(ShapeProperties.create(matrix, selectionXStart, rectY + (rectHeight / 2) - 4, selectionWidth, 8).color(0xFF5585E8).build());
            }
        }
        ...
        if (focused && (selectionStart == -1 || selectionStart == selectionEnd)) {
            ...
            blurGlass.render(ShapeProperties.create(matrix, rectX + 3 - xOffset + cursorX, rectY + (rectHeight / 2) - 3.5F, 0.5F, 7).color(-1).build());
        }
