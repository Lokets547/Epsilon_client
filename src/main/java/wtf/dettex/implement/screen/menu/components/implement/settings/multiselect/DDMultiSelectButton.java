...
import wtf.dettex.implement.screen.menu.components.implement.settings.select.SelectedButton;
...
public class DDMultiSelectButton extends AbstractComponent {
    ...
    public DDMultiSelectButton(MultiSelectSetting setting, String text) {
