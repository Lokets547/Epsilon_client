package wtf.dettex.implement.screen.menu.components.implement.window.implement.settings.group;
...
public class GroupWindow extends AbstractWindow {
    ...
    public void drawWindow(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        blurGlass.render(ShapeProperties.create(matrix, x, y, width, height)
                .round(4).thickness(2).softness(1).outlineColor(ColorUtil.getOutline()).color(ColorUtil.getRect(0.5F)).build());
