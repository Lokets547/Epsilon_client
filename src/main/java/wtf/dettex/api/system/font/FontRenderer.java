package wtf.dettex.api.system.font;
...
import wtf.dettex.api.system.font.entry.DrawEntry;
import wtf.dettex.api.system.font.glyph.Glyph;
import wtf.dettex.api.system.font.glyph.GlyphMap;
...
public class FontRenderer implements QuickImports {
    ...
    public static @NotNull Identifier randomIdentifier() {
        return Identifier.of("dettex", "temp/" + StringUtil.randomString(32));
    }
